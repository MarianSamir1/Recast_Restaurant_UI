    ...
    return BlocProvider(
      ...
      child: BaseScaffold(
        body: SingleChildScrollView(
          child: BlocBuilder<RestaurantDetailsCubit, RestaurantState>(
            ...
            builder: (context, state) => Column(
              ...
              children: [
                //==================== restaurant image and appbar Header Section ====================
                ImageHeaderWithAppBar(
                  imagePath: state.restaurant!.image,
                  showProfileIcon: true,
                ),

                //==================== restaurant info header Section ===============
                InfoHeader(
                  title: state.restaurant!.fname,
                  gradientTitle: state.restaurant!.lname,
