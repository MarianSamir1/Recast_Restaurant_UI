...
class ImageHelper extends StatelessWidget {
  ...
  Widget get _oval => ClipOval(clipBehavior: Clip.antiAlias, child: _loadImage);
  ...
  Widget get _jsonAsset => Lottie.asset(
        image,
        delegates: LottieDelegates(
          values: [ValueDelegate.color([], value: Colors.red)],
        ),
        width: width,
        alignment: alignment,
        errorBuilder: (context, error, stackTrace) => _errorBuilder,
  ...
  Widget get _jsonNetwork => Lottie.network(
        image,
        width: width,
        alignment: alignment,
        errorBuilder: (context, error, stackTrace) => _errorBuilder,
  ...
  Widget get _jsonMemory => Lottie.memory(
        dataFromBase64String(image),
        width: width,
        alignment: alignment,
        errorBuilder: (context, error, stackTrace) => _errorBuilder,
  ...
  Widget get _loaderBuilder => Center(
        child: SizedBox(
          ...
          child: FittedBox(fit: BoxFit.contain, child: _loader),
        ),
      );
